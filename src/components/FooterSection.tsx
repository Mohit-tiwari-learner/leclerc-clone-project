...
const FooterSection = () => {
  ...
  return (
    <footer id="contact" className="bg-foreground section-padding" ref={ref}>
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-12">
          <div>
            <MagneticWrap strength={0.2}>
              <p className="font-display font-black text-5xl text-primary-foreground tracking-tighter">
                <SplitText text="ARC" charClassName="text-primary-foreground" delay={0} />
                <SplitText text="." charClassName="text-primary" delay={0.1} />
              </p>
            </MagneticWrap>
            <motion.p
            ...
            >
              Award-winning architecture studio creating spaces that inspire,
              endure, and transform the way people live and work.
            </motion.p>
          </div>
          ...
          <StaggerContainer className="flex flex-col gap-3" staggerDelay={0.06}>
            ...
            {["About", "Projects", "Portfolio", "Services"].map((item) => (
          ...
          <StaggerContainer className="flex flex-col gap-3" staggerDelay={0.06}>
            ...
            <StaggerItem>
              <p className="font-body text-primary-foreground/60 text-sm">
                245 West 17th Street<br />New York, NY 10011
              </p>
            </StaggerItem>
          </StaggerContainer>
        </div>
